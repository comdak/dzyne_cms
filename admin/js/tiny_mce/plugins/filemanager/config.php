<?php
	...
	$mcFileManagerConfig['preview.wwwroot'] = $relfilepath; // absolute or relative from this script path (c:/Inetpub/wwwroot).
	$mcFileManagerConfig['preview.urlprefix'] = "/uploads/"; // domain name
	...
	$mcFileManagerConfig['filesystem.rootpath'] = $relfilepath; // absolute or relative from this script path. -- $filemanager_path
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,swf,wma,wmv,mov,mp3,ico,doc,xls,rtf,mp3,wav";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,swf,wma,wmv,mov,mp3,ico,doc,xls,rtf,mp3,wav";
	$mcFileManagerConfig['upload.invalid_extension_msg'] = "Error: Invalid extension: Valid extensions are: gif,jpg,htm,html,pdf,zip,txt,swf,wma,wmv,mov,mp3,ico,doc,xls,rtf,mp3 and wav";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,swf,wma,wmv,mov,mp3,ico,doc,xls,rtf,mp3,wav";
