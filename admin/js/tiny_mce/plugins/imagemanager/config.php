<?php
	...
	$mcImageManagerConfig['preview.wwwroot'] = $relimgpath; // absolute or relative from this script path, try to leave blank system figures it out.
	$mcImageManagerConfig['preview.urlprefix'] = "/images/"; // domain name
	...
	$mcImageManagerConfig['filesystem.rootpath'] = $relimgpath; // absolute or relative from this script path, required. -- $imagemanager_path
	...
	$mcImageManagerConfig['filesystem.include_file_pattern'] = '/\.jpg$|\.ico$|\.gif$|\.png$|\.url$|\.bmp$|\.swf$/i';
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,url,ico";
	...
	$mcImageManagerConfig['thumbnail.border_style'] = "1px solid #000000";
	...
	$mcImageManagerConfig['thumbnail.use_exif'] = true; // use exif th if avalible
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,fla,url,ico";
	$mcImageManagerConfig['upload.invalid_extension_msg'] = "Error: Invalid extension: Valid extensions are: gif,jpg,png,bmp,swf,fla,url,ico";
